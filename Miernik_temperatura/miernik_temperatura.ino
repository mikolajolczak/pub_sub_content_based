...
#define EMPTY 0
#define DELAY 1000
byte MAC[] = {0x8A, 0x6C, 0x5F, 0x53, 0x28, 0xAB}; //MAC adres karty sieciowej, to powinno byc unikatowe - proforma dla ebsim'a
